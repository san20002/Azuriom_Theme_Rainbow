            ...
            <div class="col-md-12 d-flex align-items-center justify-content-center">
                <div>
                    @can('forum.discussions')
                        <form
                            action="{{ route('forum.discussions.'.($discussion->is_pinned ? 'unpin' : 'pin'), $discussion) }}"
        ...
        @foreach($discussion->posts as $post)
            <div class="card mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-9 col-md-12">
                                    ...
                                    <span class="badge badge-label"
                                          style="{{ $post->author->role->getBadgeStyle() }};">{{ $post->author->role->name }}</span>
                                </div>
                            </div>
                ...
                <div class="card-footer text-right">
                    <button type="button" class="btn btn-primary btn-sm @if($post->isLiked()) active @endif"
