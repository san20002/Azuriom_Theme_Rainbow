        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('shop[banner][shop][title]') is-invalid @enderror"
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('shop[banner][filter][title]') is-invalid @enderror"
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('shop[banner][cart][title]') is-invalid @enderror"
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('shop[banner][user][title]') is-invalid @enderror"
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('shop[banner][coupons][title]') is-invalid @enderror"
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('shop[banner][addCoupons][title]') is-invalid @enderror"
        ...
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('shop[banner][paiement][title]') is-invalid @enderror"
