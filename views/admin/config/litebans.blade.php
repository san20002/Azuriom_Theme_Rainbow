    ...
    <div class="row">
        <div class="col-xl-4 col-lg-6">
            <fieldset class="form-group">
                ...
                <div class="small font-italic mb-2">{!! trans('theme::lang.liteBans.banner.info')!!}</div>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <select class="custom-select"
                                ...
                                @foreach(\Azuriom\Models\Image::all() as $image)
                                    <option value="{{ $image->file }}"
                                            @if(theme_config('liteBans.banner.liteban.image') === $image->file) selected @endif>{{ $image->name }}</option>
                                @endforeach
                            </select>
                            <div class="mt-3 w-100">
                                <img
                                    src="{{ theme_config('liteBans.banner.liteban.image') ? image_url( old('liteBans[banner][liteban][image]', theme_config('liteBans.banner.liteban.image')) ): ''}}"
                                    alt="{{ old('liteBans[banner][liteban][image]', theme_config('liteBans.banner.liteban.image')) }}"
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('liteBans[banner][liteban][title]', theme_config('liteBans.banner.liteban.title')) }}">
                        ...
                        <div class="custom-control custom-switch mt-2">
                            <input type="checkbox" class="custom-control-input" id="litebanBannerNewHidden"
                                   ...
                                   @if(theme_config('liteBans.banner.liteban.hidden')) checked @endif>
