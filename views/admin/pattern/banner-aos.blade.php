<div class="my-2">
    <label for="animation-{{$keyAos}}-{{$valueAos}}-{{$counterPartial}}">{{ trans('theme::lang.animation') }}</label>
    <select name="{{$keyAos}}[banner][{{$valueAos}}][animation]"
            id="animation-{{$keyAos}}-{{$valueAos}}-{{$counterPartial}}" class="form-control">
...
<div class="my-2">
    <label for="placement-{{$keyAos}}-{{$valueAos}}-{{$counterPartial}}">{{ trans('theme::lang.placement') }}</label>
...
<div class="my-2">
    <label for="duration-{{$keyAos}}-{{$valueAos}}-{{$counterPartial}}">{{ trans('theme::lang.duration') }}</label>
    <input type="text"
